...
final class EgyptPayrollCalculatorTest extends TestCase
{
    ...
    {
        $result = $this->calculator->calculate(8_000.0, 50, $this->config2026);
        $arr    = $result->toArray();
    ...
    {
        $result = $this->calculator->calculate(8_000.0, companyHeadcount: 10, config: $this->config2026);
    ...
    {
        $result = $this->calculator->calculate(8_000.0, companyHeadcount: 30, config: $this->config2026);
    ...
    {
        $result = $this->calculator->calculate(10_000.0, 50, $this->config2026);
    ...
    public function throws_on_negative_salary(): void
    {
        ...
        $this->calculator->calculate(-1_000.0, 10, $this->config2026);
    }
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        $this->calculator->calculate(8_000.0, 0, $this->config2026);
    }
}
